...
public class QuicClientConnectionImpl extends QuicConnectionImpl implements QuicClientConnection, PacketProcessor, FrameProcessorRegistry<AckFrame>, TlsStatusEventHandler, FrameProcessor3 {
    ...
    private QuicClientConnectionImpl(String host, int port, QuicSessionTicket sessionTicket, Version quicVersion, Logger log, String proxyHost, Path secretsFile, Integer initialRtt, Integer cidLength,
                                     List<TlsConstants.CipherSuite> cipherSuites,
                                     PrivKey privKey) throws UnknownHostException, SocketException {
        ...
        tlsEngine = new TlsClientEngine(new ClientMessageSender() {
            ...
            @Override
            public void send(CertificateMessage sm) throws IOException {
                getCryptoStream(Handshake).write(sm.getBytes());
            }

            @Override
            public void send(CertificateVerifyMessage cv) throws IOException {
                getCryptoStream(Handshake).write(cv.getBytes());
            }
        }, this, privKey);
    }
   ...
   /**
    ...
    public interface Builder {
        ...
        Builder privateKey(PrivKey privateKey);
    ...
    private static class BuilderImpl implements Builder {
        ...
        public QuicClientConnectionImpl build() throws SocketException, UnknownHostException {
            ...
            QuicClientConnectionImpl quicConnection = new QuicClientConnectionImpl(host, port, sessionTicket, quicVersion, log, proxyHost, secretsFile, initialRtt, connectionIdLength,
                    cipherSuites, privKey);
        ...
        @Override
        public Builder privateKey(PrivKey privateKey) {

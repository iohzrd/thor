...
public class TlsClientEngine extends TlsEngine implements ClientMessageProcessor {
    ...
    public TlsClientEngine(ClientMessageSender clientMessageSender, TlsStatusEventHandler tlsStatusHandler, PrivKey privKey) {
    ...
    public void received(ServerHello serverHello) throws MissingExtensionAlert, IllegalParameterAlert {
        ...
        // TODO if (keyShare.isEmpty() && preSharedKey.isEmpty()) {
    ...
    @Override
    public void received(CertificateRequestMessage cm) throws TlsProtocolException, IOException {
        // TODO


        CertificateMessage certificateMessage = new CertificateMessage(cm.getCertificate_request_context(),
                certificate);
        ...
        byte[] hmac = computeFinishedVerifyData(transcriptHash.getHash(
                TlsConstants.HandshakeType.certificate_verify), state.getClientHandshakeTrafficSecret());

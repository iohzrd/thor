...
// TODO import java.security.spec.NamedParameterSpec;
...
public abstract class TlsEngine implements MessageProcessor, TrafficSecrets {
    ...
    protected void generateKeys(PrivKey privKey, TlsConstants.NamedGroup namedGroup) {
        try {
            ...
            /* TODO else if (namedGroup == x25519 || namedGroup == x448) {
            ...
            //certificate = new LiteHostCertificate(privKey, keyPair).cert();

package threads.thor.magic.entries;

import java.util.HashMap;
import java.util.Map;

import threads.thor.magic.endian.EndianType;
import threads.thor.magic.types.BigEndianString16Type;
import threads.thor.magic.types.ByteType;
import threads.thor.magic.types.DefaultType;
import threads.thor.magic.types.DoubleType;
import threads.thor.magic.types.FloatType;
import threads.thor.magic.types.Id3LengthType;
import threads.thor.magic.types.IntegerType;
import threads.thor.magic.types.LittleEndianString16Type;
import threads.thor.magic.types.LocalDateType;
import threads.thor.magic.types.LocalLongDateType;
import threads.thor.magic.types.LongType;
import threads.thor.magic.types.PStringType;
import threads.thor.magic.types.RegexType;
import threads.thor.magic.types.SearchType;
import threads.thor.magic.types.ShortType;
import threads.thor.magic.types.StringType;
import threads.thor.magic.types.UtcDateType;
import threads.thor.magic.types.UtcLongDateType;

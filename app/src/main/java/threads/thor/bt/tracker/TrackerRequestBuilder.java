...
public abstract class TrackerRequestBuilder {
    ...
    /**
     * Create a tracker request builder for a given threads.torrent ID
     *
     * @since 1.0
     */
    ...
    /**
     * Announce to tracker, that the client is starting a threads.torrent session.
     *
    ...
    /**
     * Announce to tracker, that the client is stopping a threads.torrent session.
     *
     * @return Tracker response
     * @since 1.0
     */
    ...
    /**
     * Announce to tracker, that the client has completed downloading the threads.torrent.
     *
     * @return Tracker response
     * @since 1.0
     */
     ...
     *
     * @param left Amount of data that is left for the client to complete the threads.torrent download, in bytes.
     * @return Builder
     * @since 1.0
     */
     ...
     * @since 1.0
     */
    protected TorrentId getTorrentId() {
        return torrentId;
    }

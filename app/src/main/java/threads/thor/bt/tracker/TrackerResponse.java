...
public class TrackerResponse {
     ...
     * @since 1.0
     */
    private TrackerResponse(String errorMessage) {
        this(false, null);
     ...
     * @since 1.0
     */
    private TrackerResponse(Throwable error) {
     ...
     * @since 1.0
     */
    private Optional<byte[]> getTrackerId() {
        return trackerId;
    }
    ...
    /**
     * @return Number of seeders for the requested threads.torrent.
     * @since 1.0
     */
    private int getSeederCount() {
        return seederCount;
    }
    ...
    /**
     * @return Number of leechers for the requested threads.torrent.
     * @since 1.0
     */
    private int getLeecherCount() {
        return leecherCount;
    }
    ...
    /**
     * @return Collection of peers, that are active for the requested threads.torrent.
     * @since 1.0
     */

...
public class RPCStats {
     ...
     */
    void addReceivedBytes(long receivedBytes) {
     ...
     */
    void addSentBytes(long sentBytes) {
        tmpSentBytes += sentBytes;
        this.sentBytes += sentBytes;
    }

    void addSentMessageToCount(MessageBase msg) {
    ...
    void addReceivedMessageToCount(MessageBase msg) {
    ...
    void addTimeoutMessageToCount(MessageBase msg) {

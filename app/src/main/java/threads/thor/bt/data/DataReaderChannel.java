 ...
 */
class DataReaderChannel implements ReadableByteChannel {
    ...
    DataReaderChannel(@NonNull DataDescriptor dataDescriptor, long chunkSize) {
    ...
    synchronized void onPieceVerified(int pieceIndex) {

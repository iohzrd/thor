...
package threads.thor.bt.data.file;
...
/**
 * Provides file-system based storage for threads.torrent files.
 *
 * <p>Information about the collection of files in a threads.torrent is stored as a list of strings in the threads.torrent metainfo.
 ...
 * <ul>
 *     <li>all threads.torrent files are stored inside the root directory of this storage (see {@link #FileSystemStorage(File)})</li>
...
public class FileSystemStorage implements Storage {
     ...
     *
     * @param rootDirectory Root directory for this storage. All threads.torrent files will be stored inside this directory.
     * @since 1.0
     */
    ...
    public File getFile(Torrent torrent) {
        ...
        return torrentDirectory.toFile();
    }
}

...
public class LocalServiceDiscoveryConfig {
     ...
     * @since 1.6
     */
    Duration getLocalServiceDiscoveryAnnounceInterval() {
     ...
     * @since 1.6
     */
    int getLocalServiceDiscoveryMaxTorrentsPerAnnounce() {
     ...
     * @since 1.6
     */
    Collection<AnnounceGroup> getLocalServiceDiscoveryAnnounceGroups() {
